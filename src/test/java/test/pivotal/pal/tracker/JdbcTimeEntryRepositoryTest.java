...
public class JdbcTimeEntryRepositoryTest {
    ...
    public void createInsertsATimeEntryRecord() {
        TimeEntry newTimeEntry = new TimeEntry(123l, 321, LocalDate.parse("2017-01-09"), 8);
    ...
    public void updateReturnsTheUpdatedRecord() {
        ...
        TimeEntry timeEntryUpdates = new TimeEntry(456l, 987, LocalDate.parse("2017-01-10"), 10);
    ...
    public void updateUpdatesTheRecord() {
        ...
        TimeEntry updatedTimeEntry = new TimeEntry(456l, 322, LocalDate.parse("2017-01-10"), 10);
